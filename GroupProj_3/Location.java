...
public class Location {
    ...
    public void removeOccupant(DisasterVictim occupant) {
        ...
        for (int i = 0; i < this.occupants.length; i++) {
            if (this.occupant[i].equals(occupant)) {
                indexFound = i;
                break;
            }
        }
        if (index_found == -1) {
            throw new IllegalArgumentException("The occupant was not found in the array");
        }
    ...
    public void removeSupply(Supply inventory) {
        ...
        if (index_found == -1) {
            throw new IllegalArgumentException("The supply was not found in the array");
        }
